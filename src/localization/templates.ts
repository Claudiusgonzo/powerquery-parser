...
export function getLocalizationTemplates(locale: string): ILocalizationTemplates {
    const maybeTemplates: ILocalizationTemplates | undefined = TemplatesByLocale.get(locale.toLowerCase());
    return maybeTemplates !== undefined ? maybeTemplates : DefaultTemplates;
}
